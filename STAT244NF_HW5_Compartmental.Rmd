---
title: 'Homework 5: Introduction to Compartmental Modeling'
...
6. This homework assignment is **due on Friday, October 15, 2021 and should be submitted to Gradescope**.
...
HIV_sim_df$S[1] <- S0
HIV_sim_df$I[1] <- I0
HIV_sim_df$lambdaI[1] <- P_IGC*I0/N
...
I am including a separate assignment related to functions, which is similar to the last set of questions included in Homework 4. If you did not miss any points on that part of the assignment (check Gradescope), then you do not need to complete this optional assignment. **If you missed any points, you should complete this optional assignment to earn points back on your homework from last week.** I encourage you to talk with our computing TA, Reese Hirota, about this optional assignment if you have questions.
